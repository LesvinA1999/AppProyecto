...
import { StyleSheet, Text, View, TextInput, Dimensions, Button, Alert, Picker, TouchableOpacity, TextInputComponent, DrawerLayoutAndroidComponent} from 'react-native';
    ...
    if(!Usuario || !Contrasena || !IdTipoUsuario){
      ...
      try{
        const respuesta = await fetch(
          'http://192.168.0.11:7000/api/usuarios/guardar',
          {
            method: "POST", 
            headers: {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.subTitle}>Registro de cuenta</Text>
